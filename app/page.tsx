...
export default function Home() {
  ...
  const { handleSubmit, handleChange, values, errors } = useFormik({
    ...
    onSubmit(values) {
      ...
      router.push(
        `/interactive?initialDeposit=${initialDeposit}&monthly=${monthlyContribution}&retiredAge=${retiredAge}&currentAge=${currentAge}&riskLevel=${riskLevel}`
      );
    }
  });
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-12">
        ...
        <Input
          type="number"
          error={errors.retiredAge}
          value={values.retiredAge}
          onChange={handleChange}
          name="retiredAge"
        ...
        <Select
          ...
          labelTitle="Choose a risk level"
          onChange={handleChange}
