...
const EducationalChart = () => {
  ...
  const pensionSavings = useMemo(
    () =>
      createPensionElements(initialDeposit, monthlyContribution, riskLevel, retiredAge, currentAge),
    [initialDeposit, monthlyContribution, riskLevel, retiredAge, currentAge]
  );

  return (
    <>
      <h3 className="text-4xl font-extrabold dark:text-white">
        Educational Interactive Chart for Pension Plan
      </h3>
